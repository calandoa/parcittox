...
#define ACTIONS_FILE		PARCELLITE_PROG_NAME "/actions"
#define FIFO_FILE_C		PARCELLITE_PROG_NAME "/fifo_c"
#define FIFO_FILE_P		PARCELLITE_PROG_NAME "/fifo_p"
#define PREFERENCES_FILE	PARCELLITE_PROG_NAME "/" PARCELLITE_PROG_NAME "rc"
